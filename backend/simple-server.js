...
async function generateWithAI(prompt) {
    ...
    const systemPrompt = `You are an expert web developer and designer. Create a complete, professional HTML website based on the user's prompt. 

Requirements:
- Generate a complete HTML5 document with embedded CSS and JavaScript
- Use modern, responsive design with mobile-first approach
- Include professional color schemes and typography
- Add Font Awesome icons (use CDN: https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0/css/all.min.css)
- Create multiple sections (header, hero, features/services, about, contact, footer)
- Use CSS Grid and Flexbox for layouts
- Include smooth animations and hover effects
- Make it production-ready and visually appealing
- Add a small "Generated by CloudIDE" badge in the footer or corner
- Ensure the content matches the prompt's industry and purpose
